...
public class RandomModelGenerator {
    ...
    private static Object generateFromRegex(String regex, Class<?> type) {
        try {
            ...
            System.err.println("WARNING: Regex generation failed for: " + regex);
            return generateSimpleValueByType(type);
        }
    }

    private static Object generateSimpleValueByType(Class<?> type) {
        if (type.equals(String.class)) {
